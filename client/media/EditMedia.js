    ...
    return(
        <Card className={classes.card}>
            <CardContent>
                ...
                <TextField id='multiline-flexible' multiline rows='2' label='Description' className={classes.textField} value={media.description} onChange={handleChange('description')} margin='normal'/><br/>
