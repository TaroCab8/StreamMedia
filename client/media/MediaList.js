        ...
        <div className={classes.root}>
            <GridList className={classes.gridList} cols={3} >
                {props.media.map((tile,i) => (
                    ...
                    <GridListTileBar className={classes.tileBar} title={<Link to={'/media/'+tile._id} className={classes.tileTitle} >{tile.title}</Link>} subtitle={<span>
                        <span>{tile.views} views</span>
                        <span><em>{tile.genre}</em></span>
                    </span>} />
                    </GridListTile>
                ))}
            </GridList>
