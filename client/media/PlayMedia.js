    ...
    return (
        <div className={classes.root}>
            <Grid container spacing={8} >
                ...
                {relatedMedia.length > 0 && (<Grid item xs={4} sm={4} >
                    <FormControlLabel className={classes.toogle} control={<Switch checked={autoPlay} onChange={handleChange} color='primary'
                    />
                    } 
